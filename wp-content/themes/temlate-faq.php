	...
	<section id="gk-mainbody">
		...
		<?php wp_reset_query(); ?>
            ...
            <div class="not-login">
                ...
                <p>Страница закрыта для не зарегестрированных пользователей. Пожалуйсто <a href="/личная-страница/">зарегестрируйтесь</a> или <a href="wp-login.php?action=login">войдите</a> в свою учотную запись!</p>
            </div>
