			...
			<?php if(is_page(1316)) { ?>
				<div class="users-preview hidden">
					<div id="gk-mainbody-columns">
						<h1 class="hidden" style="font-size: 26px;">ПЕРСОНАЛЬНЫЕ СТРАНИЦЫ МАСТЕРОВ</h1>
						<?php if ( bp_has_members( bp_ajax_querystring( 'members' ) ) ) : ?>
						    <?php 
						        ...
						        <?php } ?>   
						    <?php endwhile; ?>  
						        <div class="member-wrap hidden" style="width: 32.8%; display: inline-block; margin-right: -4px; margin-bottom: -8px; background: #fff; border: 2px solid #DFDFDF; height: 134px;">
						            <div class="member-info">
