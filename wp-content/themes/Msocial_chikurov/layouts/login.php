...
<div id="gk-popup-login" class="gk-popup">	
	<div class="gk-popup-wrap">
		<?php if ( is_user_logged_in() ) : ?>
			<h3><?php _e('Ваш аккаунт', GKTPLNAME); ?></h3>
		...
		<?php else : ?>
		     <h3><?php _e('Войти', GKTPLNAME); ?> <small><?php _e('или ', GKTPLNAME); ?><a href="<?php echo home_url(); ?>/wp-login.php?action=register" title="<?php _e('Регистрация', GKTPLNAME); ?>"><?php _e('Зарегестрироваться', GKTPLNAME); ?></a></small></h3>
			...
			<nav class="small">
				<ul>
					<li>
						<a href="<?php echo home_url(); ?>/wp-login.php?action=lostpassword" title="<?php _e('Password Lost and Found', GKTPLNAME); ?>"><?php _e('Забыли пароль?', GKTPLNAME); ?></a>
					</li>
					<li>
