    ...
    <div class="row header">
      <div class="col-xs-12">
        ...
        <aside class="col-sm-6 col-xs-12 pull-right text-center">
          <h2>Первоэлементы</h2>
          <p>Для вращения диска необходимо захватить одну из сторон треугольника мышкой и вращать в нужном направлении. Вращая треугольник будут поочередно активироваться первоэлементы. Трегульник в любом положении всеми вершинами указывает на выбранный первоэлемент. При использовании устрофства с сенсорным экраном можно вроащать круг пальцем.</p>
