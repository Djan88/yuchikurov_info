...
<h<?php echo (is_singular()) ? '1' : '2'; ?>>
	...
	<?php endif; ?>
        <span class="h1-phone">
            <?php if(xprofile_get_field_data(9, bp_displayed_user_id())){ ?>
            <span>
                <i class="icon-phone"></i>
                <?php echo xprofile_get_field_data(9, bp_displayed_user_id()); ?>
            </span>
            <?php } ?>
            <?php if(xprofile_get_field_data(8, bp_displayed_user_id())){ ?>
            <span>
                <i class="icon-envelope"></i>
                <a style="display:inline-block;" href="mail:<?php echo xprofile_get_field_data(8, bp_displayed_user_id()); ?>"><?php echo xprofile_get_field_data(8, bp_displayed_user_id()); ?></a>
            </span>
            <?php } ?>
            <?php if(xprofile_get_field_data(10, bp_displayed_user_id())){ ?>
            <span>
                <i class="icon-skype"></i>
               <?php echo xprofile_get_field_data(10, bp_displayed_user_id()); ?>
            </span>
            <?php } ?>
        </span>
</h<?php echo (is_singular()) ? '1' : '2'; ?>>
