...
?>
	...
	<section id="gk-mainbody">
            ...
            <?php query_posts( array('category_name'=>'book', 'showposts' => 10 ) ); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <span><?php get_template_part( 'layouts/content.post.featured' ); ?></span>
