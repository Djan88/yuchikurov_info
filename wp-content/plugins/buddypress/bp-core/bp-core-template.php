...
function bp_get_options_nav() {
	...
	foreach ( (array) $bp->bp_options_nav[$the_index] as $subnav_item ) {
		...
		if ( $subnav_item['slug'] == bp_current_action() ) {
			$selected = ' class="btn btn-default current selected"';
		} else {
		...
		echo apply_filters( 'bp_get_options_nav_' . $subnav_item['css_id'], '<a id="' . '-' . $list_type . '-li" ' . $selected . $subnav_item['css_id'] . '" href="' . $subnav_item['link'] . '">' . $subnav_item['name'] . '</a>', $subnav_item );
	}
}
