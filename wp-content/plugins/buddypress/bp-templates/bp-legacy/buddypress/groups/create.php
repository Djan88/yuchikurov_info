	...
	<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<div>
					<label for="group-for-whom">Для кого предназначен семинар</label>
					<textarea name="group-for-whom" id="group-for-whom" ><?php bp_new_group_for_whom(); ?></textarea>
				</div>
				<div>
					<label for="group-place">Место проведения</label>
					<input type="text" name="group-place" id="group-place" aria-required="true" value="<?php bp_new_group_place(); ?>" />
				</div>
				<div>
					<label for="group-place-oordinates">Координаты места проведения</label>
					<input type="text" name="group-place-coordinates" id="group-place-coordinates" value="<?php bp_new_group_place_coordinates(); ?>" />
				</div>
				<?php do_action( 'groups_custom_group_fields_editable' ); // @Deprecated ?>
				<div>
					<strong style="font-size: 18px;margin-top: 12px;display: block;">Данные организатора</strong>
				</div>
				<div>
					<label for="group-master-fio">ФИО</label>
					<input type="text" name="group-master-fio" id="group-master-fio" value="<?php bp_new_group_master_fio(); ?>" />
				</div>
				<div>
					<label for="group-master-telephone">Телефон</label>
					<input type="text" name="group-master-telephone" id="group-master-telephone" value="<?php bp_new_group_master_telephone(); ?>" />
				</div>
				<div>
					<label for="group-master-email">E-mail</label>
					<input type="text" name="group-master-email" id="group-master-email" value="<?php bp_new_group_master_fio(); ?>" />
				</div>
				<?php
