...
class BP_Groups_Theme_Compat {
	...
	public function directory_dummy_post() {
		...
		if ( is_user_logged_in() && bp_user_can_create_groups() ) {
			$title = __( 'Groups', 'buddypress' ) . '&nbsp;<a class="btn btn-warning" href="' . trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() . '/create' ) . '">' . __( 'Создать семинар', 'buddypress' ) . '</a>';
		} else {
