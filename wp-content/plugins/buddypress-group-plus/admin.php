...
function bpgp_register_settings() {
	...
	register_setting( 'bpgp_plugin_options', 'group_plus_header_textfield_name2' );
        register_setting( 'bpgp_plugin_options', 'group_plus_header_textfield3' );
        register_setting( 'bpgp_plugin_options', 'group_plus_header_textfield_link3' );
	register_setting( 'bpgp_plugin_options', 'group_plus_header_textfield_name3' );
	...
	$default_plus_header_textfield_name2 = 'Text Field 2';
        $default_plus_header_textfield_name3 = 'Text Field 3';
	...
	$default_plus_map_name = 'Location';
		...
		if(get_option('group_plus_header_textfield_name2') == ''){ update_option('group_plus_header_textfield_name2', $default_plus_header_textfield_name2); }
                if(get_option('group_plus_header_textfield_name3') == ''){ update_option('group_plus_header_textfield_name3', $default_plus_header_textfield_name3); }
