...
<table class="form-table">
	<tr valign="top">
		<th scope="row">Enable Text Field (3)</th>
    		<td><input type="checkbox" name="group_plus_header_textfield3" value="1" <?php checked( 1, get_option('group_plus_header_textfield3') ); ?> /></td>
		</tr>
</table>
...
<table class="form-table">
	<tr valign="top">
		<th scope="row">Enable <b>links</b></th>
    		<td><input type="checkbox" name="group_plus_header_textfield_link3" value="1" <?php checked( 1, get_option('group_plus_header_textfield_link3') ); ?> /></td>
		</tr>
</table>
<table class="form-table">
	<tr valign="top">
		<th scope="row">Customize the <b>name</b></th>
            <td><input style="overflow:auto;" name="group_plus_header_textfield_name3" value="<?php echo get_option('group_plus_header_textfield_name3') ?>"/></td>
		</tr>
</table>
<?php
	} else { //disbale it
...
<table class="form-table">
	<tr valign="top">
		<th scope="row" style="color:#888; text-decoration:line-through;">Enable <b>links</b></th>
    		<td><input disabled="disabled" type="checkbox" name="group_plus_header_textfield_link3" value="1" <?php checked( 1, get_option('group_plus_header_textfield_link3') ); ?> /></td>
		</tr>
</table>
<table class="form-table">
	<tr valign="top">
		<th scope="row" style="color:#888; text-decoration:line-through;">Customize the <b>name</b></th>
            <td><input disabled="disabled" style="overflow:auto;" name="group_plus_header_textfield_name3" value="<?php echo get_option('group_plus_header_textfield_name3') ?>"/></td>
		</tr>
</table>
<?php
	}
